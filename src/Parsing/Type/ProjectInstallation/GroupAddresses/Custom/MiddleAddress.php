...
class MiddleAddress
{
     ...
     * @param array<\Avolle\KnxProject\Parsing\Type\ProjectInstallation\GroupAddresses\Custom\SubAddress>|null $subAddresses
     */
    public function __construct(
        ...
        #[MapFrom('GroupAddress')]
        #[CastToListArray]
        #[CastListToType(SubAddress::class)]
        public ?array $subAddresses,
    ) {
    }
}
